...
CCamera	g_Camera(CameraType::ThirdPerson);
CCamera debugCamera(CameraType::FirstPerson);
...
/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
	...
	g_Camera.PositionCamera(0, 10.f, 6, 0, 1.5f, 0, 0, 1, 0);
	debugCamera.PositionCamera(0, 10.f, 6, 0, 1.5f, 0, 0, 1, 0);
...
/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
	...
	CVector3 CameraPos = g_Camera.Position();
	//Debug image for current pos of camera
	//CreatePyramid(CameraPos.x, CameraPos.y, CameraPos.z, 1, 1);
...
/////// * /////////// * /////////// * NEW * /////// * /////////// * /////////// *
	CVector3 CamView = g_Camera.View();
	//CamView = CamView.NormalizedVector3D();
	//CamView = CamView * 5;
	glTranslatef(CamView.x, -(CamView.y), CamView.z);

	// Create a pyramid at (0, 2, 0) with a width and height of 1
	//CreatePyramid(0, 10, 0, 1, 1);
...
void Update()
{
	...
	if (bDebugCamera)
	{
		if (GetKeyState('O') & 0x80) {
			...
			g_Camera.RotateAroundPoint(g_Camera.View(), rotatespeed, 0, 1, 0);
		}
